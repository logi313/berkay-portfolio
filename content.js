...
window.PORTFOLIO = {
  ...
  categories: [
    { id: 'films', number: '01', title: 'Films',
      projects: [
        { id: 'vr-show', title: 'Another Life', type: 'Visual narrative', year: '', role: 'AI filmmaking',
    ...
    { id: 'short-form', number: '03', title: 'Short-form',
      projects: [
        { id: 'bed', title: 'Five More Minutes', type: 'Short-form', year: '', role: 'AI image & motion', description: 'An ordinary bed moves through a world that refuses to slow down.', poster: 'assets/short-bed-poster.jpg', focal: '50% 50%', preview: 'assets/short-bed-preview.mp4', film: 'assets/films/bed.mp4', previewLength: 0, captions: '' },
        { id: 'bubble-world', title: 'Personal Space', type: 'Short-form', year: '', role: 'AI image & motion', description: 'A playful reality expands around one impossible bubble.', poster: 'assets/short-bubble-world-poster.jpg?v=5', focal: '50% 50%', preview: 'assets/short-bubble-world-preview.mp4?v=5', film: 'assets/films/bubble-world.mp4', previewLength: 0, captions: '' },
        { id: 'burger-macro', title: 'Double Smash', type: 'Short-form', year: '', role: 'AI image & motion', description: 'Heat, texture and appetite captured at an impossibly close scale.', poster: 'assets/short-burger-macro-poster.jpg?v=2', focal: '50% 50%', preview: 'assets/short-burger-macro-preview.mp4?v=2', film: 'assets/films/burger-macro.mp4', previewLength: 0, captions: '' },
        { id: 'camera-motion', title: 'Own the Frame', type: 'Short-form', year: '', role: 'AI image & motion', description: 'A mountain at first light, and the camera made to carry it home.', poster: 'assets/short-camera-motion-poster.jpg?v=2', focal: '50% 50%', preview: 'assets/short-camera-motion-preview.mp4?v=2', film: 'assets/films/camera-motion.mp4', previewLength: 0, captions: '' },
        { id: 'car-versions', title: 'Colorway', type: 'Short-form', year: '', role: 'AI image & motion', description: 'A single automotive idea evolves through contrasting visual worlds.', poster: 'assets/short-car-versions-poster.jpg', focal: '50% 50%', preview: 'assets/short-car-versions-preview.mp4', film: 'assets/films/car-versions.mp4', previewLength: 0, captions: '' },
        { id: 'coat-01', title: 'Above the Weather', type: 'Fashion motion', year: '', role: 'AI image & motion', description: 'Fashion in motion, shaped by silhouette, altitude and cold air.', poster: 'assets/short-coat-01-poster.jpg', focal: '50% 50%', preview: 'assets/short-coat-01-preview.mp4', film: 'assets/films/coat-01.mp4', previewLength: 0, captions: '' },
        { id: 'coat-02', title: 'Water Off', type: 'Fashion motion', year: '', role: 'AI image & motion', description: 'A trench coat walks through a car wash and comes out untouched.', poster: 'assets/short-coat-02-poster.jpg?v=2', focal: '50% 50%', preview: 'assets/short-coat-02-preview.mp4?v=2', film: 'assets/films/coat-02.mp4', previewLength: 0, captions: '' },
        { id: 'drink-ad', title: 'Slow Summer', type: 'Product motion', year: '', role: 'AI image & motion', description: 'Colour, condensation and impact built around one refreshing moment.', poster: 'assets/short-drink-ad-poster.jpg?v=2', focal: '50% 50%', preview: 'assets/short-drink-ad-preview.mp4?v=2', film: 'assets/films/drink-ad.mp4', previewLength: 0, captions: '' },
        { id: 'eyewear', title: 'Change the View', type: 'Fashion motion', year: '', role: 'AI image & motion', description: 'Eyewear becomes character through clean framing and controlled motion.', poster: 'assets/short-eyewear-poster.jpg', focal: '50% 50%', preview: 'assets/short-eyewear-preview.mp4', film: 'assets/films/eyewear.mp4', previewLength: 0, captions: '' },
        ...
        { id: 'luxury-real-estate', title: 'After Dark', type: 'Architecture motion', year: '', role: 'AI image & motion', description: 'Light and architecture guide a compact tour through modern luxury.', poster: 'assets/short-luxury-real-estate-poster.jpg', focal: '50% 50%', preview: 'assets/short-luxury-real-estate-preview.mp4', film: 'assets/films/luxury-real-estate.mp4', previewLength: 0, captions: '' }
      ]
    }
  ]
};
