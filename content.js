  ...
  categories: [
    ...
    { id: 'short-form', number: '02', title: 'Short-form',
      projects: [
        ...
        { id: 'camera-motion', title: 'Through the Lens', type: 'Short-form', year: '', role: 'AI image & motion', description: 'A mountain at first light, and the camera made to carry it home.', poster: 'assets/short-camera-motion-poster.jpg?v=3', focal: '50% 50%', preview: 'assets/short-camera-motion-preview.mp4?v=2', film: 'assets/films/camera-motion.mp4', previewLength: 0, captions: '' },
        { id: 'drink-ad', title: 'Poolside Sparkle', type: 'Product motion', year: '', role: 'AI image & motion', description: 'Colour, condensation and impact built around one refreshing moment.', poster: 'assets/short-drink-ad-poster.jpg?v=3', focal: '50% 50%', preview: 'assets/short-drink-ad-preview.mp4?v=2', film: 'assets/films/drink-ad.mp4', previewLength: 0, captions: '' },
        ...
        { id: 'coat-01', title: 'Summit Jacket', type: 'Fashion motion', year: '', role: 'AI image & motion', description: 'Fashion in motion, shaped by silhouette, altitude and cold air.', poster: 'assets/short-coat-01-poster.jpg?v=2', focal: '50% 50%', preview: 'assets/short-coat-01-preview.mp4', film: 'assets/films/coat-01.mp4', previewLength: 0, captions: '' },
        ...
        { id: 'coat-02', title: 'Waterproof Trench', type: 'Fashion motion', year: '', role: 'AI image & motion', description: 'A trench coat walks through a car wash and comes out untouched.', poster: 'assets/short-coat-02-poster.jpg?v=2', focal: '50% 50%', preview: 'assets/short-coat-02-preview.mp4?v=2', film: 'assets/films/coat-02.mp4', previewLength: 0, captions: '' },
        { id: 'bubble-world', title: 'Bubblegum ’90s', type: 'Short-form', year: '', role: 'AI image & motion', description: 'A ’90s school hallway, one giant bubble and all the space she needs.', poster: 'assets/short-bubble-world-poster.jpg?v=6', focal: '50% 50%', preview: 'assets/short-bubble-world-preview.mp4?v=5', film: 'assets/films/bubble-world.mp4', previewLength: 0, captions: '' },
        ...
        { id: 'car-versions', title: 'The Color Garage', type: 'Short-form', year: '', role: 'AI image & motion', description: 'A single automotive idea evolves through contrasting visual worlds.', poster: 'assets/short-car-versions-poster.jpg', focal: '50% 50%', preview: 'assets/short-car-versions-preview.mp4', film: 'assets/films/car-versions.mp4', previewLength: 0, captions: '' },
