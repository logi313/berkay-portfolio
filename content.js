...
window.PORTFOLIO = {
  ...
  categories: [
    { id: 'commercials', number: '01', title: 'Commercials',
      projects: [
        { id: 'one-last-message', title: 'One Last Message', type: 'Smartphone concept film',
          description: 'A smartphone concept film: a grandmother’s voice message, kept for the day she’s gone, holds a lifetime of small moments.', poster: 'assets/film-message-poster.jpg', focal: '50% 50%', preview: 'assets/film-message-preview.mp4', film: 'assets/films/one-last-message.mp4', previewLength: 0, captions: '' },
        { id: 'the-impossible-drive', title: 'The Impossible Drive', type: 'Automotive concept film',
          description: 'An electric SUV concept film: one message from a hotel room sets off a drive through city lights, desert roads and a mountain sunset.', poster: 'assets/commercial-impossible-drive-poster.jpg?v=2', focal: '50% 50%', preview: 'assets/commercial-impossible-drive-preview.mp4?v=2', film: 'assets/films/the-impossible-drive.mp4?v=2', previewLength: 0, captions: '' },
    ...
    { id: 'short-form', number: '02', title: 'Short-form',
      projects: [
        { id: 'eyewear', title: 'City Frames', type: 'Eyewear concept spot', description: 'An eyewear concept where amber lenses turn a grey business district into her own city.', poster: 'assets/short-eyewear-poster.jpg', focal: '50% 50%', preview: 'assets/short-eyewear-preview.mp4', film: 'assets/films/eyewear.mp4', previewLength: 0, captions: '' },
        { id: 'camera-motion', title: 'Through the Lens', type: 'Camera concept spot', description: 'A camera concept spot, from first light on the mountain to the one frame worth keeping.', poster: 'assets/short-camera-motion-poster.jpg?v=3', focal: '50% 50%', preview: 'assets/short-camera-motion-preview.mp4?v=2', film: 'assets/films/camera-motion.mp4', previewLength: 0, captions: '' },
        { id: 'drink-ad', title: 'Poolside Sparkle', type: 'Drink concept spot', description: 'A sparkling drink concept: a lazy afternoon on a pool float, and the one thing worth reaching for.', poster: 'assets/short-drink-ad-poster.jpg?v=3', focal: '50% 50%', preview: 'assets/short-drink-ad-preview.mp4?v=2', film: 'assets/films/drink-ad.mp4', previewLength: 0, captions: '' },
        { id: 'bed', title: 'The Bed Commute', type: 'Bed concept spot', description: 'A bed brand concept: too comfortable to get up, he takes his bed all the way to the office.', poster: 'assets/short-bed-poster.jpg', focal: '50% 50%', preview: 'assets/short-bed-preview.mp4', film: 'assets/films/bed.mp4', previewLength: 0, captions: '' },
        { id: 'coat-01', title: 'Summit Jacket', type: 'Outerwear concept spot', description: 'An outerwear concept, from desert rock to a summit above the clouds, made for whatever the weather does.', poster: 'assets/short-coat-01-poster.jpg?v=2', focal: '50% 50%', preview: 'assets/short-coat-01-preview.mp4', film: 'assets/films/coat-01.mp4', previewLength: 0, captions: '' },
        { id: 'flavor-switch', title: 'Mixed Up', type: 'Ice cream concept spot', description: 'An ice cream concept: strawberry, lemon, orange, pistachio and chocolate in one bar that can’t pick a flavour.', poster: 'assets/short-flavor-switch-poster.jpg?v=2', focal: '50% 50%', preview: 'assets/short-flavor-switch-preview.mp4?v=2', film: 'assets/films/flavor-switch.mp4', previewLength: 0, captions: '' },
        { id: 'coat-02', title: 'Waterproof Trench', type: 'Outerwear concept spot', description: 'A waterproof outerwear concept: a trench coat walks through a car wash and comes out dry.', poster: 'assets/short-coat-02-poster.jpg?v=2', focal: '50% 50%', preview: 'assets/short-coat-02-preview.mp4?v=2', film: 'assets/films/coat-02.mp4', previewLength: 0, captions: '' },
        { id: 'bubble-world', title: 'Bubblegum ’90s', type: 'Bubblegum concept spot', description: 'A bubblegum concept set in a ’90s school hallway, where one giant bubble clears all the space she needs.', poster: 'assets/short-bubble-world-poster.jpg?v=6', focal: '50% 50%', preview: 'assets/short-bubble-world-preview.mp4?v=5', film: 'assets/films/bubble-world.mp4', previewLength: 0, captions: '' },
        { id: 'burger-macro', title: 'Double Smash', type: 'Burger concept spot', description: 'A burger brand concept: cheese melts, pickles drop and two smashed patties stack into one perfect burger.', poster: 'assets/short-burger-macro-poster.jpg?v=2', focal: '50% 50%', preview: 'assets/short-burger-macro-preview.mp4?v=2', film: 'assets/films/burger-macro.mp4', previewLength: 0, captions: '' },
        { id: 'car-versions', title: 'The Color Garage', type: 'Automotive concept spot', description: 'A sports car concept: one car, three colours and three rooms of light, revealed one door at a time.', poster: 'assets/short-car-versions-poster.jpg', focal: '50% 50%', preview: 'assets/short-car-versions-preview.mp4', film: 'assets/films/car-versions.mp4', previewLength: 0, captions: '' },
        { id: 'luxury-real-estate', title: 'Skyline Residence', type: 'Real estate concept film', description: 'A luxury real estate concept: warm light, stone and a rooftop terrace above the city after dark.', poster: 'assets/short-luxury-real-estate-poster.jpg', focal: '50% 50%', preview: 'assets/short-luxury-real-estate-preview.mp4', film: 'assets/films/luxury-real-estate.mp4', previewLength: 0, captions: '' }
      ]
    },
