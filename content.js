...
window.PORTFOLIO = {
  ...
  categories: [
    ...
    { id: 'short-form', number: '02', title: 'Short-form',
      projects: [
        { id: 'eyewear', title: 'City Frames', type: 'Eyewear spot', description: 'Amber lenses turn a grey business district into her own city.', poster: 'assets/short-eyewear-poster.jpg', focal: '50% 50%', preview: 'assets/short-eyewear-preview.mp4', film: 'assets/films/eyewear.mp4', previewLength: 0, captions: '' },
